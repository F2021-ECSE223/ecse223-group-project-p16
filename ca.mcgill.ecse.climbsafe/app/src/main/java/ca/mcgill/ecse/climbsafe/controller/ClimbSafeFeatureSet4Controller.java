...
/**
 * Here are the controller features for addEquipment and updateEquipment as specified by the
 * administrator when defining the set of available equipment.
 * 
 * @author Rui Du
 *
 */
...
public class ClimbSafeFeatureSet4Controller {
   ...
   * updateEquipment:
   * 
   * Controller feature to update the name, weight, or price per week of an existing bookable
   * equipment.
   * 
   * @author Rui Du
   * 
   * @param oldName The old name of the existing equipment. This is used to identify the equipment
   *        to update.
