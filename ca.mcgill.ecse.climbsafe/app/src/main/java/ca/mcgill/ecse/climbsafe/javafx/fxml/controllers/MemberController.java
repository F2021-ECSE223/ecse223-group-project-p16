...
public class MemberController {
	...
	// initializing the register member interactable components
		...
		@FXML
		private TextField regPasswordTextFeild;
		@FXML
		private TextField regEmergencyContactTextFeild;
		@FXML
		private TextField regNrWeeksTextFeild;
		@FXML
		private TextField regEquipNamesTextFeild;
		@FXML
		private TextField regEquipQuantityTextFeild;
		@FXML
		...
		@FXML
		private TextField cancelNameTextFeild;
		@FXML
 ...
 */
	...
	public void cancelBookingButton(ActionEvent event) {
		...
		String name= cancelNameTextFeild.getText();
